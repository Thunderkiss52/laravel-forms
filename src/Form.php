...
use Exception;
use Thunderkiss52\LaravelForms\Elements\BulletList;
use Thunderkiss52\LaravelForms\Elements\Checkbox;
use Thunderkiss52\LaravelForms\Elements\Date;
use Thunderkiss52\LaravelForms\Elements\DateRange;
use Thunderkiss52\LaravelForms\Elements\MultipleSelect;
use Thunderkiss52\LaravelForms\Elements\Number;
use Thunderkiss52\LaravelForms\Elements\Option;
use Thunderkiss52\LaravelForms\Elements\Radio;
use Thunderkiss52\LaravelForms\Elements\SearchSelect;
use Thunderkiss52\LaravelForms\Elements\Select;
use Thunderkiss52\LaravelForms\Elements\Text;
use Thunderkiss52\LaravelForms\Elements\Textarea;
use Thunderkiss52\LaravelForms\Elements\TimeRange;
use Thunderkiss52\LaravelForms\Elements\TimeSelect;
use Thunderkiss52\LaravelForms\Models\Draft;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Support\Arr;
use Illuminate\Support\Collection;
use ReflectionClass;
use Thunderkiss52\LaravelForms\Attributes\Name;
...
class Form extends Data
{
    ...
    public static function filterFields(array $rows, ?string $type = null): array
    {
